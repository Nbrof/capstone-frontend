...
const About = (props) => {
    ...
    return (
        <div>
            <h1>Space was hard</h1>
            <br></br>
            <div><h4>At the start of the 1980's there was only 318 satellites in orbit around earth, A rather manageable number for an era that was primarly dominated by advances in spaceflight. This 
